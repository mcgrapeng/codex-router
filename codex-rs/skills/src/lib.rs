...
/// Returns the on-disk cache location for embedded system skills from an absolute CODEXROUTER_HOME.
...
/// Installs embedded system skills into `CODEXROUTER_HOME/skills/.system`.
///
