...
pub enum UpdateAction {
    /// Update via `npm install -g @zhang3f/codexrouter@latest`.
    NpmGlobalLatest,
    /// Update via `bun install -g @zhang3f/codexrouter@latest`.
    BunGlobalLatest,
...
impl UpdateAction {
    ...
    pub fn command_args(self) -> (&'static str, &'static [&'static str]) {
        match self {
            UpdateAction::NpmGlobalLatest => ("npm", &["install", "-g", "@zhang3f/codexrouter"]),
            UpdateAction::BunGlobalLatest => ("bun", &["install", "-g", "@zhang3f/codexrouter"]),
