...
pub(crate) const CODEX_ROUTER_LOGO_WIDTH: usize = 64;

const CODEX_ROUTER_LOGO: [&str; 6] = [
    "   _____          _              _____             _            ",
    "  / ____|        | |            |  __ \\           | |           ",
    " | |     ___   __| | _____  __  | |__) |___  _   _| |_ ___ _ __ ",
    " | |    / _ \\ / _` |/ _ \\ \\/ /  |  _  // _ \\| | | | __/ _ \\ '__|",
    " | |___| (_) | (_| |  __/>  <   | | \\ \\ (_) | |_| | ||  __/ |   ",
    "  \\_____\\___/ \\__,_|\\___/_/\\_\\  |_|  \\_\\___/ \\__,_|\\__\\___|_|   ",
];
