...
pub(crate) enum TerminalTitleItem {
    ...
    WeeklyLimit,
    /// Codex Router application version.
    CodexVersion,
...
impl TerminalTitleItem {
    pub(crate) fn description(self) -> &'static str {
        match self {
            TerminalTitleItem::AppName => "Codex Router app name",
            ...
            TerminalTitleItem::CodexVersion => "Codex Router application version",
