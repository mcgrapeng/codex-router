...
const APP_TOOLTIP: &str = "Try the **Codex Router App**. Run 'codexrouter app' or visit https://chatgpt.com/codex?app-landing-page=true";
const FAST_TOOLTIP: &str =
    "*New* Use **/fast** to enable our fastest inference with increased plan usage.";
const OTHER_TOOLTIP: &str = "*New* Build faster with the **Codex Router App**. Run 'codexrouter app' or visit https://chatgpt.com/codex?app-landing-page=true";
const OTHER_TOOLTIP_NON_MAC: &str = "*New* Build faster with Codex Router.";
const FREE_GO_TOOLTIP: &str = "*New* For a limited time, Codex Router is included in your plan for free – let’s build together.";
...
lazy_static! {
    static ref TOOLTIPS: Vec<&'static str> = RAW_TOOLTIPS
        ...
        .filter(|line| {
            ...
            if !IS_MACOS && !IS_WINDOWS && line.contains("codexrouter app") {
                return false;
            }
            true
        })
...
/// Pick a random tooltip to show to the user when starting Codex Router.
...
[[announcements]]
content = "Welcome to Codex Router! Check out the new onboarding flow."
