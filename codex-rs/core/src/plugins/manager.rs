...
impl PluginsManager {
    ...
    pub fn new_with_restriction_product(
        ...
        // Product restrictions are enforced at marketplace admission time for a given CODEXROUTER_HOME:
        ...
        // contents of that CODEXROUTER_HOME and does not re-filter configured plugins by product, so
        // already-admitted plugins may continue exposing MCP servers/tools from shared local state.
        //
        // This assumes a single CODEXROUTER_HOME is only used by one product.
        Self {
