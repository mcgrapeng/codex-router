...
- unix socket (`--listen unix://` or `--listen unix://PATH`): websocket frames over `$CODEXROUTER_HOME/app-server-control/app-server-control.sock` or a custom socket path without HTTP upgrade
...
- `memory/reset` — experimental; clear the current `CODEXROUTER_HOME/memories` directory and reset persisted memory stage data in sqlite while preserving existing thread memory modes; returns `{}` on success.
...
{ "method": "turn/start", "id": 33, "params": {
    ...
    "input": [
        ...
        { "type": "skill", "name": "skill-creator", "path": "/Users/me/.codexrouter/skills/skill-creator/SKILL.md" }
    ]
} }
{ "id": 33, "result": { "turn": {
    "id": "turn_457",
  ...
  "params": {
    ...
    "input": [
      ...
      },
      {
        "type": "skill",
        "name": "skill-creator",
        "path": "/Users/me/.codexrouter/skills/skill-creator/SKILL.md"
      }
    ]
  }
}
...
```json
{
  ...
  "id": 26,
  "params": {
    "path": "/Users/alice/.codexrouter/skills/skill-creator/SKILL.md",
    "name": null,
    "enabled": false
  }
}
