...
#[derive(Debug, Parser)]
#[command(bin_name = "codexrouter plugin marketplace")]
...
#[derive(Debug, Parser)]
#[command(bin_name = "codexrouter plugin marketplace add")]
...
#[derive(Debug, Parser)]
#[command(bin_name = "codexrouter plugin marketplace upgrade")]
struct UpgradeMarketplaceArgs {
    marketplace_name: Option<String>,
}

#[derive(Debug, Parser)]
#[command(bin_name = "codexrouter plugin marketplace remove")]
