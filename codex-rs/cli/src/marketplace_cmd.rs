...
#[derive(Debug, Parser)]
#[command(bin_name = "coder plugin marketplace")]
...
#[derive(Debug, Parser)]
#[command(bin_name = "coder plugin marketplace add")]
...
#[derive(Debug, Parser)]
#[command(bin_name = "coder plugin marketplace upgrade")]
struct UpgradeMarketplaceArgs {
    marketplace_name: Option<String>,
}

#[derive(Debug, Parser)]
#[command(bin_name = "coder plugin marketplace remove")]
