...
/// Expected structure for $CODEXROUTER_HOME/auth.json.
...
impl FileAuthStorage {
    ...
    /// Attempt to read and parse the `auth.json` file in the given `CODEXROUTER_HOME` directory.
...
const KEYRING_SERVICE: &str = "Codex Router Auth";
