...
3. **Document behavior.** If your change affects user-facing behavior, update the README, inline help (`coder --help`), or relevant example projects.
...
Together we can make Codex Router CLI an incredible tool. **Happy hacking!** :rocket:
