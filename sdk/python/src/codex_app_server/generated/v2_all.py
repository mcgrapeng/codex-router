...
class ProjectConfigLayerSource(BaseModel):
    ...
    project_config_folder: Annotated[
        AbsolutePathBuf, Field(alias="projectConfigFolder")
    ]
...
class ExternalAgentConfigDetectParams(BaseModel):
    ...
    include_home: Annotated[
        ...
        Field(
            alias="includeHome",
            description="If true, include detection under the user's home (~/.claude, ~/.codexrouter, etc.).",
        ),
    ] = None
