...
export type CodexOptions = {
  ...
  apiKey?: string;
  /**
   * Additional `--config key=value` overrides to pass to the Codex Router CLI.
   *
  ...
  /**
   * Environment variables passed to the Codex Router CLI process. When provided, the SDK
